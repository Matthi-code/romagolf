...
3. **Expert Quote**: "Quote here" - Expert Name [3]

Citations:
[1] Author. (Year). "Title". Publication.
[2] Author. (Year). "Title". Publication.
[3] Author. (Year). Interview/Article.
...
**Inline Citations**:
```markdown
Studies show 40% productivity improvement (Author, 2024).
```
...
[1] Author. (2024). "Title". Publication.
```
...
Maintain a running citations list in research.md.
...
- Use recent data when possible (< 5 years)
...
1. **Work in VS Code/Claude Code**: Better than web for long-form writing
